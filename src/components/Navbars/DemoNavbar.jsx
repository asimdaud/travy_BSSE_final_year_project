  ...
  hey
                ...
                <UncontrolledDropdown nav>
                  ...
                  <img
                          ...
                          // alt="..."
                          src={       JSON.parse(localStorage.getItem("uid"))?       "https://firebasestorage.googleapis.com/v0/b/travycomsats.appspot.com/o/profilePics%2F(" +
                          JSON.parse(localStorage.getItem("uid")) +
                          ")ProfilePic?alt=media&token=69135050-dec6-461d-bc02-487766e1c81d":       "https://image.shutterstock.com/image-vector/vector-man-profile-icon-avatar-260nw-1473553328.jpg"                        }
                        />
                  </DropdownToggle>
                  <DropdownMenu
